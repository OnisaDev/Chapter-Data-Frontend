...
import { addLibro, getGeneros, getUsuario } from '../api';
import './AddBook.css';
...
function AddBook() {
  ...
  const [formData, setFormData] = useState({ titulo: '', autor: '', id_genero: '', isbn: '', fecha_lectura: '', resena: '' });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setExito('✅ Libro añadido correctamente.');
      setFormData({ titulo: '', autor: '', id_genero: '', isbn: '', fecha_lectura: '', resena: '' });
      setRating(0);
    } catch (err) {
